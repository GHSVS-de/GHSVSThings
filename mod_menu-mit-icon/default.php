...
foreach ($list as $i => &$item)
{
	...
	if (
		...
		$item->svg = '<span class="' . $menuImageCss . '" aria-hidden="true">'
			. '</span>';

		/*
		Füge Leezeichen an, wenn Titel angezeigt werden soll und Icon vor Titel
		kommen soll.
		Derzeit aber irgendwie ein Bug oder Unlogik in Joomla 4 RC2.
